...
MAP_TILES_RAW = [
	...
	[8, '02-B', 2, 5, 85, 94, bg],
	[9, '02-C', 2, 5, 83, 78, bg],
	[10, '02-D', 2, 5, 85, 94, bg],
	[11, '02-E', 2, 5, 85, 78, bg],
	[12, '02-F', 2, 5, 85, 94, bg],
	[13, '02-G', 2, 5, 85, 78, bg],
	[14, '02-H', 2, 5, 85, 94, bg],
	[15, '03-A', 4, 4, 72, 120, bg],
	[16, '03-B', 4, 4, 68, 78, bg],
	[17, '03-C', 4, 4, 68, 78, bg],
	[18, '03-D', 4, 4, 70, 75, bg],
	[19, '04-A', 5, 5, 75, 154, bg],
	[20, '04-B', 5, 5, 68, 154, bg],
	[21, '04-C', 5, 5, 70, 156, bg],
	[22, '04-D', 5, 5, 70, 156, bg],
	[23, '05-A', 5, 5, 68, 78, bg],
	[24, '05-B', 5, 5, 72, 93, bg],
	[25, '06-A', 9, 3, 67, 52, bg],
	[26, '06-B', 9, 3, 65, 52, bg],
	[27, '07-A', 8, 3, 70, 57, bg],
	[28, '07-B', 8, 3, 85, 56, bg],
	[29, '07-C', 8, 3, 85, 39, bg],
	[30, '07-D', 8, 3, 85, 56, bg],
	[31, '09-A', 7, 7, 70, 232, bg],
	[32, '09-B', 7, 7, 69, 250, bg],
	[33, '09-C', 7, 7, 70, 234, bg],
	[34, '09-D', 7, 7, 70, 250, bg],
	[35, '10-A', 5, 6, 87, 43, bg],
	[36, '10-B', 5, 6, 87, 58, bg],
	[37, '10-C', 5, 6, 85, 42, bg],
	[38, '10-D', 5, 6, 84, 58, bg],
	[39, '11-A', 7, 9, 86, 52, bg],
	[40, '11-B', 7, 9, 86, 43, bg],
	[41, '11-C', 7, 9, 86, 52, bg],
	[42, '11-D', 7, 9, 86, 43, bg],
	[43, '12-A', 6, 8, 66, 115, bg],
	[44, '12-B', 6, 8, 70, 110, bg],
	[45, '12-C', 6, 8, 66, 108, bg],
	[46, '12-D', 6, 8, 70, 112, bg],
	[47, '13-A', 7, 5, 85, 52, bg],
	[48, '13-B', 7, 5, 88, 41, bg],
	[49, '13-C', 7, 5, 85, 52, bg],
	[50, '13-D', 7, 5, 85, 41, bg],
	[51, '13-E', 7, 5, 85, 52, bg],
	[52, '13-F', 7, 5, 83, 41, bg],
	[53, '15-A', 7, 6, 83, 117, bg],
	[54, '15-B', 7, 6, 83, 117, bg],
	[55, '16-A', 7, 8, 83, 55, bg],
	[56, '16-B', 7, 8, 83, 40, bg],
];
...
CONDITIONS_INITIAL = [
	...
	[3, 'curse', true, false],
	[4, 'disarm', true, false],
	[5, 'immobilize', true, false],
	[6, 'impair', true, false],
	[7, 'invisible', true, false],
	[8, 'muddle', true, false],
	[9, 'poison', true, false],
	[10, 'regenerate', true, false],
	[11, 'safeguard', true, false],
	[12, 'strengthen', true, false],
	[13, 'stun', true, false],
	[14, 'ward', true, false],
	[15, 'wound', true, false],
	[16, 'berserker', true, false],
	[17, 'demolitionist', true, false],
	[18, 'doom', true, false],
