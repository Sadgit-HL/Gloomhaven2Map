...
OVERLAYTILES_RAW = [
	...
	[3, 'co pressure_plate', 1, 1, 45, 39, bg],
...
MOVABLE_TOKENS2_RAW = [
	...
	[1, 'ob_altar', 1, 1, 45, 39, bg],
	[2, 'ob_barrel', 1, 1, 45, 39, bg],
	[3, 'ob_bookshelf_2', 1, 1, 45, 39, bg],
	[4, 'ob_boulder', 1, 1, 45, 39, bg],
	[5, 'ob_boulder_2', 1, 1, 45, 39, bg],
	[6, 'ob_boulder_3', 1, 1, 45, 39, bg],
	[7, 'ob_bush', 1, 1, 45, 39, bg],
	[8, 'ob_cabinet', 1, 1, 45, 39, bg],
	[9, 'ob_crate', 1, 1, 45, 39, bg],
	[10, 'ob_crystal', 1, 1, 45, 39, bg],
	[11, 'ob_dark_pit', 1, 1, 45, 39, bg],
	[12, 'ob_fountain', 1, 1, 45, 39, bg],
	[13, 'ob_nest', 1, 1, 45, 39, bg],
	[14, 'ob_rock_column', 1, 1, 45, 39, bg],
	[15, 'ob_rubble', 1, 1, 45, 39, bg],
	[16, 'ob_sarcophagus_2', 1, 1, 45, 39, bg],
	[17, 'ob_stalagmites', 1, 1, 45, 39, bg],
	[18, 'ob_stone_pillar', 1, 1, 45, 39, bg],
	[19, 'ob_stump', 1, 1, 45, 39, bg],
	[20, 'ob_supply_shelf_2', 1, 1, 45, 39, bg],
	[21, 'ob_table_2', 1, 1, 45, 39, bg],
	[22, 'ob_tree_3', 1, 1, 45, 39, bg],
	[23, 'ob_wall_2', 1, 1, 45, 39, bg],
	[24, 'tr_bear_trap', 1, 1, 45, 39, bg],
	[25, 'tr_poison_trap', 1, 1, 45, 39, bg],
	[26, 'tr_spike_pit_trap', 1, 1, 45, 39, bg],
...
var MONSTERS_RAW = [
	...
	[4, 'Bandit Scout', 1, 1, 41, 35, bg, false, [dummy], false],
	[5, 'Black Imp', 1, 1, 41, 35, bg, false, [dummy], false],
	[6, 'Cave Bear', 1, 1, 41, 35, bg, false, [dummy], false],
	[7, 'Chaos Demon', 1, 1, 41, 35, jotl, false, [dummy], false],
	[8, 'City Archer', 1, 1, 41, 35, bg, false, [dummy], false],
	[9, 'City Guard', 1, 1, 41, 35, bg, false, [dummy], false],
	[10, 'Crystal Rot', 1, 1, 41, 35, bg, false, [dummy], false],
	[11, 'Cultist', 1, 1, 41, 35, bg, false, [dummy], false],
	[12, 'Deep Terror', 1, 1, 41, 35, bg, false, [dummy], false],
	[13, 'Earth Demon', 1, 1, 41, 35, bg, false, [dummy], false],
	[14, 'Flame Demon', 1, 1, 41, 35, bg, false, [dummy], false],
	[15, 'Forest Imp', 1, 1, 41, 35, bg, false, [dummy], false],
	[16, 'Frost Demon', 1, 1, 41, 35, bg, false, [dummy], false],
	[17, 'Giant Viper', 1, 1, 41, 35, bg, false, [dummy], false],
	[18, 'Harrower Infester', 1, 1, 41, 35, bg, false, [dummy], false],
	[19, 'Hound', 1, 1, 41, 35, bg, false, [dummy], false],
	[20, 'Inox Archer', 1, 1, 41, 35, bg, false, [dummy], false],
	[21, 'Inox Guard', 1, 1, 41, 35, bg, false, [dummy], false],
	[22, 'Inox Priest', 1, 1, 41, 35, bg, false, [dummy], false],
	[23, 'Living Bones', 1, 1, 41, 35, bg, false, [dummy], false],
	[24, 'Living Corpse', 1, 1, 41, 35, bg, false, [dummy], false],
	[25, 'Living Spirit', 1, 1, 41, 35, bg, false, [dummy], false],
	[26, 'Lurker Soldier', 1, 1, 41, 35, bg, false, [dummy], false],
	[27, 'Night Demon', 1, 1, 41, 35, bg, false, [dummy], false],
	[28, 'Ooze', 1, 1, 41, 35, bg, false, [dummy], false],
	[29, 'Rending Drake', 1, 1, 41, 35, bg, false, [dummy], false],
	[30, 'Savvas Icestorm', 1, 1, 41, 35, bg, false, [dummy], false],
	[31, 'Savvas Lavaflow', 1, 1, 41, 35, bg, false, [dummy], false],
	[32, 'Spitting Drake', 1, 1, 41, 35, bg, false, [dummy], false],
	[33, 'Stone Construct', 1, 1, 41, 35, bg, false, [dummy], false],
	[34, 'Sun Demon', 1, 1, 41, 35, bg, false, [dummy], false],
	[35, 'Vermling Priest', 1, 1, 41, 35, bg, false, [dummy], false],
	[36, 'Vermling Scout', 1, 1, 41, 35, bg, false, [dummy], false],
	[37, 'Wind Demon', 1, 1, 41, 35, bg, false, [dummy], false],
];
...
var LIEUTENANTS_RAW = [
	...
	[2, 'Bug Body', 1, 1, 41, 35, bg, false],
	[3, 'Candlekeeper Thrice', 1, 1, 41, 35, bg, false],
	[4, 'First Shield Harmon', 1, 1, 41, 35, bg, false],
	[5, 'Inox Bodyguard', 1, 1, 41, 35, bg, false],
	[6, 'Jekserah', 1, 1, 41, 35, bg, false],
	[7, 'Merciless Taskmaster', 1, 1, 41, 35, bg, false],
	[8, 'The Betrayer', 1, 1, 41, 35, bg, false],
	[9, 'The Colorless', 1, 1, 41, 35, bg, false],
	[10, 'The Dark Rider', 1, 1, 41, 35, bg, false],
	[11, 'The Elder Drake', 1, 1, 41, 35, bg, false],
	[12, 'The Gloom', 1, 1, 41, 35, bg, false],
	[13, 'The Prime Demon', 1, 1, 41, 35, bg, false],
	[14, 'The Sightless Eye', 1, 1, 41, 35, bg, false],
	[15, 'Winged Horror', 1, 1, 41, 35, bg, false],
];
...
var HEROES_RAW = [
	...
	[28, 'Plagueherald', 1, 1, 41, 35, bg, , , dummy],
...
FAMILIARS_RAW = [
	...
	[7, 'destruction', 1, 1, 45, 39, bg],
	[8, 'gadget', 1, 1, 45, 39, bg],
	[9, 'lava', 1, 1, 45, 39, bg],
	[10, 'negative trap', 1, 1, 45, 39, bg],
	[11, 'positive trap', 1, 1, 45, 39, bg],
	[12, 'rift', 1, 1, 45, 39, bg],
	[13, 'sand devil', 1, 1, 45, 39, bg],
	[14, 'shadow', 1, 1, 45, 39, bg],
	[15, 'tear', 1, 1, 45, 39, bg],
	[16, 'treasure', 1, 1, 45, 39, bg],
	[17, 'oj bookshelf 2', 1, 1, 45, 39, bg],
	[18, 'oj cave rock 2', 1, 1, 45, 39, bg],
	[19, 'oj crate', 1, 1, 45, 39, bg],
	[20, 'oj rock column', 1, 1, 45, 39, bg],
	[21, 'oj rubble', 1, 1, 45, 39, bg],
	[22, 'oj sarcophagus 2', 1, 1, 45, 39, bg],
	[23, 'oj stalagmites', 1, 1, 45, 39, bg],
	[24, 'oj stone door', 1, 1, 45, 39, bg],
	[25, 'oj stone pillar', 1, 1, 45, 39, bg],
	[26, 'oj tree 3', 1, 1, 45, 39, bg],
	[27, 'scenario aid', 1, 1, 45, 39, bg],
];
