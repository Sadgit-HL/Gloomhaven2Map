...
function Create_HeroListValues() {
    ...
    // Convert object → array and sort alphabetically by title
    var heroesSorted = Object.values(HEROES_LIST).sort((a, b) => 
    ...
    heroesSorted.forEach(hero => {
        ...
        if (heroLine.DisplayExpansionNameInSelect == true) {
            additionalText = '- ' + hero.expansion;
        }
        html += addOption(hero.title + ' ' + additionalText, '', 'Set_Hero(this, \'' + hero.id + '\')');
    });
